...
#cityscapes_15k
	#res:128
python train.py --name cityscapes_15k_128 --dataset_mode cityscapes_15k_weighted --dataroot /home/sazadi/projects/segGAN/dynamo/datasets --gpu_ids 8,9 --batchSize 28 --tf_log  --niter 20 --niter_decay 20 --no_instance \
